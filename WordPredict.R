...
#Remove sparse items
unigram <- TermDocumentMatrix(corpus, control = list(tokenize = unigramTokenizer, removeSparseTerms=0.8))
bigram <- TermDocumentMatrix(corpus, control = list(tokenize = bigramTokenizer, removeSparseTerms=0.8))
trigram <- TermDocumentMatrix(corpus, control = list(tokenize = trigramTokenizer, removeSparseTerms=0.8))
